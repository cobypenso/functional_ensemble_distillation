...
from src.distilled import distilled_network, gauss_logits, inv_wish
import src.loss as custom_loss


class Model(distilled_network.DistilledNet):
    """Separate Normal-Inverse Wishart network
    Network that independently predicts the parameters
    of a normal distribution and an inverse Wishart.
    ...
    Args:
        ...
        learning_rate (float)
    """
    def __init__(self, layer_sizes, target_dim, teacher, device,
                 variance_transform, learning_rate):
        ...
        self.norm_network = gauss_logits.Model(
